...
def build_parser() -> argparse.ArgumentParser:
    ...
    s.add_argument("--date-min", required=True, help="inclusive; DD.MM.YYYY or YYYY-MM-DD")
    s.add_argument("--date-max", required=True, help="inclusive; DD.MM.YYYY or YYYY-MM-DD")
